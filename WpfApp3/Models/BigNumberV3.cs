...
{
    public class BigNumberV3
    {
        private int[] number;
        private const int Base = 10;

        public BigNumberV3(string input)
        {
            List<int> digits = new();
        ...
        public BigNumberV3 getBigNumberV3()
        {
            return new BigNumberV3(this.getStringNumber());
        }

        public void Add(BigNumberV3 bnum)
        {
            List<int> result = new();
            int carry = 0;
        ...
        public void Substruct(BigNumberV3 bnum)
        {
            if (CompareTo(bnum) < 0)
        ...
        private int CompareTo(BigNumberV3 other)
        {
